...
----
$ git clone git@github.com:lavernw1/rest-http-vert-x
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/lavernw1/rest-http-vert-x/edit/master/src/main/resources/webroot/index.html[`src/main/resources/webroot/index.html`]).
